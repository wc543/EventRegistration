...
const { sendEventReminder, sendPaymentConfirmation } = require('../helpers/email');

router.post("/sendconfirmation", authMiddleware, async (req, res) => {
    const user_email = req.user.email;

    try {
        await sendPaymentConfirmation(user_email);
